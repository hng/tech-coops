...
[Drivers Cooperative - Colorado](https://www.coloradodrivers.coop) | Driver-owned rideshare | Denver, Colorado, USA | Drivers own 100% of the company. Modeled after "The Drivers Cooperative" in New York City.
...
[Resolana CoLaboratory](https://resolanacolab.com/) | Strategic planning, Web applications (Drupal/Wordpress/custom), Visual production, Tech guidance | Distributed / Remote, North America | We specialize in custom web development, technical migrations, visual production, and experience design for mission-driven organizations.
...
[CTRLback](https://ctrlback.coop/) | UX/UI design, mobile, Front-end, Back-end, open source software | Barcelona, Spain | Worker-owned cooperative focused on social impact & digital sovereignty |
